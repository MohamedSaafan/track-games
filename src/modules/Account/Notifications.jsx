...
import { TownIcon, TrackIcon } from "../../assets";
...
const Notifications = () => {
  ...
  return (
    <Container className="my-5">
      ...
      >
        <Tab eventKey="recentActivity" title="Recent Activity" tabClassName="custom-tab">
          <NotificationCard
            image={TrackIcon}
        ...
        <Tab eventKey="distributionRewards" title="Distribution Rewards" tabClassName="custom-tab">
          <NotificationCard
            image={TrackIcon}
            mainText="You mined 320.24 Track"
            subText="DISTRIBUTION REWARD"
        ...
        <Tab eventKey="withdrawals" title="Withdrawals" tabClassName="custom-tab">
          <NotificationCard
            image={TrackIcon}
